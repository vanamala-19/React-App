...
import './Mainpage.css'
import Notloged from'./MyComponents/Notloged'
import Loged from'./MyComponents/logedin'
...
const MainPage = () => {
    ...
    // lets use this constants as booleans to check the device
    ...
    return (
        <div>
            {breaking_point_desktop && <div className='topbar'>
                ...
                {user_signed_in ? <Loged pic = {u4}/> : <Notloged/>}
                </div>
            </div>}

            {/* Banner */}
            <Banner pic ={banner} pic2={arrowback} mobile ={breaking_point_mobile} desktop={breaking_point_desktop} userSigned = {user_signed_in} userdata = {setUser_signed_in} />
            
            {/* NavBar */}
            <NavBar pic1 = {leaveicon} pic2 = {groupicon} desktop={breaking_point_desktop} userSigned = {user_signed_in} userdata = {setUser_signed_in} />
            ...
            <div style={{width: (breaking_point_desktop ? '50%' : '100%'), overflowY: 'scroll', height: (breaking_point_desktop ? '83vh' : '94vh')}}>
                ...
                {/* Posts */}
            <Post title = "✍️ Article" details="What if famous brands had regular fonts? Meet RegulaBrands!" name = " Sarthak Kamra" pic1 = {rec1} pic2 = {menuicon} pic3 = {u1} pic4 = {shareicon} desktop={breaking_point_desktop} />

            <br />

            <Post title = "&#128300; Education" details="Tax Benefits for Investment under National Pension Scheme launched by Government" name = "Sarah West" pic1 = {rec2} pic2 = {menuicon} pic3 = {u2} pic4 = {shareicon} desktop={breaking_point_desktop} />
